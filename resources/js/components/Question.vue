  ...
  <v-stepper v-model="e1">
    <v-stepper-items>
      ...
      <v-stepper-content step="2">
        ...
        <v-btn :disabled="!user.q2" class="icon_button" :color="this.color" @click="e1 = 3">Continue</v-btn>
      ...
      <v-stepper-content step="4">
        ...
        <v-btn :disabled="!user.q4" class="icon_button" :color="this.color" @click="e1 = 5">Continue</v-btn>
