            ...
            <v-toolbar flat color="white">
                        ...
                        <v-card-text>
                            <v-container>
                                <v-row>
                                    ...
                                    <v-col cols="12" sm="6" md="6">
                                        <v-checkbox
                                            v-model="editedItem.lock_color"
                                            label="Lock logo and color"
                                        ></v-checkbox>
                                    </v-col>
                                    <v-col cols="12" sm="6" md="6">
                                        <v-file-input
                                            show-size
                                            label="Picture"
                                            @change="selectFilePicture"
                                        ></v-file-input>
                                    </v-col>
                                    <v-col cols="12" sm="12" md="6">
                                        Banner Color
                                        <v-color-picker
                                            v-model="editedItem.banner_color"
                                            flat
                                        ></v-color-picker>
                                    </v-col>
                                    <v-col cols="12" sm="12" md="6">
                                    ...
                                    <v-col cols="12" sm="12" md="6">
                                        Button Color
                                        <v-color-picker
                                            v-model="editedItem.button_color"
                                            flat
                                        ></v-color-picker>
                                    </v-col>
                                </v-row>
                ...
                <v-dialog v-model="dialog_view" max-width="50%">
                    <v-card class="mx-auto" max-width="70%">
                        <v-img
                            v-bind:src="'/storage/images/' + editedItem.picture"
                            height="200px"
                        ></v-img>
